...
public interface ExerciseRepository extends JpaRepository<Exercise, Long> {
	...
	List<Exercise> getExercisesByUserLevelAndSubject(@Param("user") User user, @Param("level") LevelType level, @Param("subject") String subject);
	...
	Optional<ExercisesQuantity> getQuantityOfTheSameExercise(@Param("user") User user, @Param("level") LevelType level, @Param("subject") String subject);
