...
INSERT INTO "task" ("prompt","subject_id","shuffle_options") VALUES
    ...
    ('What is ___ painting in this Gallery?',1 ,false),
    ('My car is ___ than yours.',1 ,false),
    ('It was ___ thing.',1 ,false),
    ('It is not ___  it was yesterday.',1 ,false),
    ('He was not  ___ I thought he would be.',1 ,false),
    ('The children were ___ gold.',1 ,false),
    ('The tickets were twice ___  before.',1 ,false),
...
INSERT INTO "task_options" ("task_id","correct","prompt") VALUES
	 (59,1,'adjectives and other adverbs.'),
	 (59,0,'pronouns and other nouns.'),
	 (60,0,'true'),
	 (60,1,'false'),
	 (61,0,'will'),
	 (61,0,'win'),
	 ...
	 (64,0,'true'),
	 (64,1,'false'),
	 (65,0,'They ran quickly.'),
	 (65,0,'The boys slept heavily.'),
	 (65,0,'She dances well.'),
	 (65,0,'He runs fast.'),
	 (65,1,'We worked hardly.'),
	 (66,0,'She talks friendly.'),
	 (66,0,'I am quietly.'),
	 (66,0,'That smells well.'),
	 (66,1,'You sang that song nicely.'),
	 (66,0,'This sounds greatly.'),
	 (67,0,'The child ran happily towards his mother.'),
	 (67,1,'Lisa walked to the shops.'),
	 (67,0,'That smells well.'),
	 (67,0,'Brendan gently woke the sleeping baby.'),
	 (68,0,'We use an adverb to say how something happens.'),
	 (68,0,'We use an adverb to say how often something happens.'),
	 (68,0,'We use an adverb to say when or where something happens.'),
	 (68,1,'We use an adverb in place of a noun.'),
	 (69,1,'yesterday'),
	 (69,0,'slowly'),
	 (69,0,'loudly'),
	 (69,0,'upstairs'),
...
-- ##### Ordinary "quest" ############## --	 
INSERT INTO "quest" ("user_id", "title", "subject_id", "start_date", "finish_date", "time_interval", "time_unit", "finished", "pin", "time_zone") values (2, 'test_quest', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + 4, 2, 7, false, '11111', 'UTC');
...
INSERT INTO "quest" ("user_id", "title", "subject_id", "start_date", "finish_date", "time_interval", "time_unit", "finished", "pin", "time_zone") values (2, 'quest_one_expired', 1, CURRENT_TIMESTAMP - 1, CURRENT_TIMESTAMP + 2, 3, 7, false, '22222', 'UTC');
...
INSERT INTO "quest" ("user_id", "title", "subject_id", "start_date", "finish_date", "time_interval", "time_unit", "finished", "pin", "time_zone") values (2, 'quest_low_interval', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + 0.008333334, 3, 4, false, '33333', 'UTC');
...
INSERT INTO "quest" ("user_id", "title", "subject_id", "start_date", "finish_date", "time_interval", "time_unit", "finished", "pin", "time_zone") values (2, 'very_short_quest', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + 0.002777776, 2, 4, false, '44444', 'UTC');
...
INSERT INTO "quest" ("user_id", "title", "subject_id", "start_date", "finish_date", "time_interval", "time_unit", "finished", "pin", "time_zone") values (2, 'already_finished_quest', 1, CURRENT_TIMESTAMP - 2, CURRENT_TIMESTAMP, 2, 7, true, '55555', 'UTC');
...
INSERT INTO "temporary_trial_data_store"("finished", "quest_id", "score", "tasks_index", "trial_number", "trial_id", "user_id") values (false, 1, 0, 0, 1, 1, 4);

INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 4);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 10);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 7);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 17);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 14);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 2);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 19);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 20);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 13);
INSERT INTO "temporary_trial_data_store_reduced_tasks_list"("temporary_trial_data_store_id", "reduced_tasks_list_id") values (1, 5);
